...
inpDirPath ='/home/adit/Desktop/DCASE2017-baseline-system-master/applications/data/TUT-acoustic-scenes-2017-development/audio'# '/home/deepu/research/DCASE2017/Data/EmoDB/535/'
ubmList,nameList = [],[]
for rootDirPath, subDir, files in os.walk(inpDirPath):
   for fileName in files:
       ...
       #print(os.path.splitext(relFile)[0])
